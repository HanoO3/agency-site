...
const PROCESS_STEPS = [
  {
    ...
    details: ["Stakeholder Interviews", "Technical Feasibility Audit", "Competitive Positioning", "Creative Direction"],
  },
  {
    number: "02",
    title: "Strategy",
    ...
    details: ["Information Architecture", "Interactive Wireframing", "Motion Concepts", "Technical Stack Specification"],
  },
  {
    number: "03",
    title: "Creation",
    ...
    details: ["3D Spatial Modeling", "Custom Shader Development", "Front-end Architecture", "Micro-Interaction Design"],
  },
  {
    number: "04",
    title: "Launch",
    ...
    description:
      "Rigorous 8k resolution performance optimization, cross-platform shader validation, zero-downtime global deployment, and ongoing creative support.",
    details: ["Performance Benchmarking", "Cross-Browser Quality Audit", "Edge Deployment", "Post-Launch Refinement"],
  },
];

export default function Process() {
  return (
    <section id="process" className="relative w-full bg-[#05050A] py-32 md:py-44 px-6 z-10">
      {/* Background Volumetric Ember Rim Glow */}
      <div className="absolute left-1/2 -translate-x-1/2 bottom-10 w-[650px] h-[650px] rounded-full bg-[radial-gradient(circle_at_center,rgba(224,67,43,0.08)_0%,rgba(5,5,10,0)_70%)] blur-[140px] pointer-events-none -z-10" />
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative mt-16 ml-4 md:ml-12 border-l border-white/10 space-y-16 md:space-y-24 pl-8 md:pl-16">
          {PROCESS_STEPS.map((step, idx) => (
            <ScrollReveal key={step.number} delay={idx * 0.1} y={30}>
              <div className="group relative">
                {/* Small Circular Marker on Line */}
                <div className="absolute -left-[41px] md:-left-[73px] top-3.5 w-4 h-4 rounded-full border border-[#E0432B] bg-[#05050A] group-hover:bg-[#E0432B] group-hover:shadow-[0_0_15px_#E0432B] transition-all duration-300 flex items-center justify-center">
                  <div className="w-1.5 h-1.5 rounded-full bg-[#E0432B] group-hover:bg-white transition-colors duration-300" />
                </div>

                <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-8 bg-[#08080E]/60 p-8 sm:p-10 rounded-2xl border border-white/10 group-hover:border-[#E0432B]/30 transition-all duration-500 hover:bg-[#08080E]">
                  {/* Left Step Header */}
                  <div>
                  ...
                  <div className="max-w-xl">
                    ...
                    <div className="grid grid-cols-2 gap-3 pt-4 border-t border-white/5">
                      {step.details.map((detail, dIdx) => (
                        <div key={dIdx} className="flex items-center gap-2 text-xs font-mono text-white/40">
